...
import productLifeCycleManagementIcon from "../../assets/icons/services/product-life-cycle-management.png";
import crossPlatformMobileAppDevelopmentIcon from "../../assets/icons/services/cross-platform-mobile-app-development.png";
import migrationAndModernizationIcon from "../../assets/icons/services/migration-and-modernization.png";
import performanceTestingIcon from "../../assets/icons/services/performance-testing.png";
import webAndMobileBasedTestingIcon from "../../assets/icons/services/web-and-mobile-based-testing.png";
import automationTestingIcon from "../../assets/icons/services/automation-testing.png";
import softwareTestingLifecycleIcon from "../../assets/icons/services/software-testing-lifecycle.png";
import securityTestingIcon from "../../assets/icons/services/security-testing.png";
import databaseTestingIcon from "../../assets/icons/services/database-testing.png";
import userInterfaceUIDesignIcon from "../../assets/icons/services/user-Interface-ui-design.png";
...
export const serviceSections = {
  software_development: {
    ...
    rows: [
      ...
      [
        ...
        {
          icon: crossPlatformMobileAppDevelopmentIcon,
        ...
        {
          icon: migrationAndModernizationIcon,
  ...
  software_testing: {
    ...
    rows: [
      ...
      [
        {
          icon: softwareTestingLifecycleIcon,
  ...
  ui_ux_design: {
    ...
    rows: [
      [
        {
          icon: userInterfaceUIDesignIcon,
        ...
        {
          icon: userExperienceUXDesignIcon,
